...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/src/Acme/DemoBundle/Entity')), 'Acme\\DemoBundle\\Entity');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
