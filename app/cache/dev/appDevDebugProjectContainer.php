...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_611746e2ebd53420947b87a30af64da30d4d31329731a5576882ca7fd2848541');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_611746e2ebd53420947b87a30af64da30d4d31329731a5576882ca7fd2848541');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_611746e2ebd53420947b87a30af64da30d4d31329731a5576882ca7fd2848541');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/src/assessmentOne/Bundle/Entity')), 'assessmentOne\\Bundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('assessmentOneBundle' => 'assessmentOne\\Bundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/src/assessmentOne/Bundle/Resources/views', 'assessmentOne');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/Resources/views');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev',
            'kernel.logs_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/logs',
            'kernel.bundles' => array(
                ...
                'assessmentOneBundle' => 'assessmentOne\\Bundle\\assessmentOneBundle',
            ...
            'debug.container.dump' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/../web',
            'assetic.write_to' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/XAMPP/xamppfiles/htdocs/assessmentOne/app/cache/dev/doctrine/orm/Proxies',
